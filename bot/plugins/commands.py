...
async def start(bot, update):
    ...
    if update_channel:
        ...
        if file_type == "document":
            ...
            await bot.send_document(
                ...
                document = file_id,
                caption = caption + "POWERED BY @Tamilblasters_Win" +"JOIN US : https://t.me/+1oRgqJt3obc1MzI1",
                parse_mode="html",
    ...
    buttons = [[
        ...
        InlineKeyboardButton('Channel 🔔', url ='https://t.me/Tamilblasters_Win')
    ],[
        InlineKeyboardButton('Group 📣', url='https://t.me/Tamilblasters_Win')
    ],[
